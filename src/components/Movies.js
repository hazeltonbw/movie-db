...
import { getModalIsOpenById, selectMovieById, selectSelectedMovieId, setMovieDetailsModalIsOpenById} from "../store/moviesReducer"
...
function Movies() {
  ...
  if (error || !movies || isEmpty(movies)) {
    return <h1 style={{ textAlign: "center", color:"red" }}>Unable to load movies.. try again!</h1>;
  }
